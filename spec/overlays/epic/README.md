...
An `epic` is a concise product requirements document. It states evidence, scope, success measures, technical invariants, cross-task risks, and child-task boundaries. An `epic` does not specify an implementation mechanism or perform child-task acceptance.
